import { globalVariable } from "./variabels.js";
...
function testWhenTheMachineHaveZeroCoinChange() {
    ...
    */
    ...
    let expect = "[1x20cent]";
    let actual = utilities.isThereAnyCoinChangeInMachine(1.8, 5);
    if (actual === expect) {
...
function testWhenTheMachineHaveCoinChange() {
    ...
    */
    ...
    utilities.updateMachineCash(Denomination.twentyCent, 1);
    utilities.updateMachineCash(Denomination.oneDollar, 3);
    let expect = "[1x10cent] + [1x1$]";
    let actual = utilities.isThereAnyCoinChangeInMachine(3.7, 22);
    if (actual === expect) {
